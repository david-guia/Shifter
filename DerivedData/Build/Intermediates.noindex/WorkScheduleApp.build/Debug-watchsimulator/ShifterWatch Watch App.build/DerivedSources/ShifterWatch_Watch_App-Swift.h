...
#ifndef SHIFTERWATCH_WATCH_APP_SWIFT_H
#define SHIFTERWATCH_WATCH_APP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ShifterWatch_Watch_App",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22ShifterWatch_Watch_App16WatchDataManager")
...
@class WCSession;
@class NSString;
@interface WatchDataManager (SWIFT_EXTENSION(ShifterWatch_Watch_App)) <WCSessionDelegate>
